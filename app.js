...
var uiController = (function () {
    ...
    return {
        ...
        displayDate: function () {
            ...
            document.querySelector(DOMstrings.dateLabel).textContent = unuudur.getMonth() + ", " + unuudur.getFullYear();
        },
...
var financeController = (function () {
    ...
    Expense.prototype.getPercentrage = function () {
    ...
    return {
        tusuvTootsooloh: function () {
            // Нийт орлогын нийлбэр тооцоолох
            calculateTotal('inc');
    ...
    var setupEventListeners = function () {
        ...
        document.querySelector(DOM.containerDiv).addEventListener('click', function (event) {
            ...
            if (id) {
                ...
                // 2. Дэдгэц дээрээс энэ элементийг устгана. 
